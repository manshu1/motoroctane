...
const Adbanner1 = () => {
  return (
<div style={{ width: '100%', overflow: 'hidden', height: '126px' , alignItems:'center', justifyContent:'center', display:'flex' , marginTop:'-40px',marginBottom:'20px', zIndex:'2', position:'relative'}}>
